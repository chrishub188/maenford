...
export const Manifest: ManifestElement[] = [
    {
        status: 'in use', id: 588519, containerID: 'AME171', content: [
            { name: 'Drums w/ oil contaminated Waste', itemId: 300908252, amount: '1', weight: '1.01', recipient: 'SAR AS' },
            { name: 'Pallet W/ Empty Cans', itemId: 300908252, amount: '1', weight: '1.01', recipient: ' ' }], location: 'Area 2', type: 'Container', weight: '2.1', size: '3 (1.6x1.9)', DG: '1.4 UN 0352', arrival: '01.01.2020', sender: 'ASCO',
    },

    {
        ...
        { name: 'MST Stinger protector', itemId: 300908252, amount: '1', weight: ' ', recipient: ' ' },], location: 'Area 2', type: 'Container', weight: '1.9', size: '3 (1.6x1.9)', DG: '-', arrival: '01.01.2020', sender: 'Haliburton Cement'
    },
...

    {
        status: 'in use', id: 582064, containerID: 'BL-16-06', content: [
            { name: ' 12 1/4" String Mill, 6 5/8" REG Box x Pin', itemId: undefined, amount: '1', weight: '', recipient: '' },
            { name: ' 6 3/4" PDM Mud motor, NC 50 Box x 4 1/2" REG Box', itemId: undefined, amount: '1 ', weight: '', recipient: '' },
            { name: ' 6 3/4" PDM Mud motor, NC 50 Box x 4 1/2" REG Box', itemId: undefined, amount: '1 ', weight: '', recipient: '' },
            { name: ' 8 1/2" Taper Mill, DPM DS 50 Box', itemId: undefined, amount: '1 ea', weight: '', recipient: '' },
            { name: ' 9 5/8" FRM Spear, 6 5/8" REG Box x Pin', itemId: undefined, amount: '1 ea', weight: '', recipient: '' },
            { name: ' ALO Valve, 6 5/8" REG Box x Pin', itemId: undefined, amount: '1', weight: '', recipient: '' },
            { name: ' Float Valve, DPM DS 50 Box x Pin', itemId: undefined, amount: '1', weight: '', recipient: '' },
            { name: ' Pup Joint, 5 7/8" OD Shank, 6 5/8" REG Box xPin', itemId: undefined, amount: '4', weight: '', recipient: '' },
            { name: ' Pup Joint, DPM DS 50 Box x Pin', itemId: undefined, amount: '1', weight: '', recipient: '' },
            { name: ' SSV Valve, 6 5/8" REG Box x Pin', itemId: undefined, amount: '1', weight: '', recipient: '' },
...

    {
        ...
        { name: ' Fishing magnet', itemId: undefined, amount: '1', weight: '', recipient: '' },], location: 'Area 2', type: 'Basket', weight: '5.6', size: '12.2 (10.2x1.2)', DG: '-', arrival: '01.01.2020', sender: 'BH Fishing Service'
    },
